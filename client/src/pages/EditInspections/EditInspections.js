...
const EditInspections = ({ inputs, title }) => {
  ...
  const sendData = () => {
    ...
    axios
      .put("/backend/api/inspections/" +clientId, data)
      .then((res , err) => {
        console.log(res);
        console.log(err);
  ...
  useEffect(() => {
   ...
   console.log(clientId)
      axios
      .get("/backend/api/inspections/"+clientId)
      .then((res) => {
        setData(res.data[0]);
  ...
  return (
    ...
    <div className="singleContainer">
      ...
      <h1 className="title">Edit Inspection informations:</h1>
